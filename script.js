...
document.addEventListener('DOMContentLoaded', function() {
  ...
  document.querySelector('.chat-box .btn-close').addEventListener('click', toggleChatBox);
  document.getElementById('chatInput').addEventListener('keypress', function(e) {
    if (e.key === 'Enter') {
      sendChatMessage();
    }
  });
  document.querySelector('.chat-footer button').addEventListener('click', sendChatMessage);
});
